...
class ProvinceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //161
        DB::table('provinces')->insert([
            'province_name' => 'Chorasmia',
            'region' => '33'
        ]);
        //162
        DB::table('provinces')->insert([
            'province_name' => 'Bactriana',
            'region' => '33'
        ]);
        //163
        DB::table('provinces')->insert([
            'province_name' => 'Sogdiana',
            'region' => '33'
        ]);
        //164
        DB::table('provinces')->insert([
            'province_name' => 'Drangiana',
            'region' => '33'
        ]);
        //165
        DB::table('provinces')->insert([
