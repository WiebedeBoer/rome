class Emporium extends THREE.Group {
  ...
  while (i < mxi){
    ...
    if (tench ==this.type){
        ...
        if (tench =="theatrum"){
            ...
            buildingMesh.position.z = (1800 - 3600) + (jezi * 90) - 75; //theatre row
        }
        //circus
        else if (tench =="circus"){
          buildingMesh.position.x = (1800 - 3600) + ((40 + i - (jezi * 40)) * 90) - 30; //circus column
