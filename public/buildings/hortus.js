class Hortus extends THREE.Group {
    ...
    //material
    var hallMaterials = [
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/tree/tree_transparent.png"), side: THREE.FrontSide, opacity: opaq.opacity,transparent: true }), //LEFT
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/tree/tree_transparent.png"), side: THREE.FrontSide, opacity: opaq.opacity,transparent: true  }), //RIGHT
        ...
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/tree/tree_transparent.png"), side: THREE.FrontSide, opacity: params.opacity,transparent: true  }), //FRONT
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/tree/tree_transparent.png"), side: THREE.FrontSide, opacity: params.opacity,transparent: true  }), //BACK
        ];
