class Praetorium extends THREE.Group {
    ...
    var hallMaterials = [
        ...
        new THREE.MeshPhongMaterial({ map: new THREE.TextureLoader().load("textures/roof/"+this.topTex+".jpg"), side: THREE.FrontSide }), //TOP
    ...
    constructor(type,frontTex,backTex,rightTex,leftTex,topTex,bHeight,bWidth,bDepth,crow,ccol){
    super();
    this.type = type;
