class PersonMaid extends THREE.Group {
    ...
    var hallMaterials = [
        ...
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/units/"+this.frontTex+".gif"), side: THREE.FrontSide, opacity: opaq.opacity,transparent: true  }), //FRONT
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/units/"+this.frontTex+".gif"), side: THREE.FrontSide, opacity: opaq.opacity,transparent: true  }), //BACK
        ];
