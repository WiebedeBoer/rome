class PersonBar extends THREE.Group {
    ...
    //material
    var hallMaterials = [
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/units/"+this.frontTex+".gif"), side: THREE.FrontSide, opacity: opaq.opacity,transparent: true }), //LEFT
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/units/"+this.frontTex+".gif"), side: THREE.FrontSide, opacity: opaq.opacity,transparent: true  }), //RIGHT
