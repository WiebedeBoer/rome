class Military extends THREE.Group {
    ...
    //material
    var hallMaterials = [
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/military/"+this.frontTex+".gif"), side: THREE.FrontSide, opacity: params.opacity,transparent: true }), //LEFT
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/military/"+this.frontTex+".gif"), side: THREE.FrontSide, opacity: params.opacity,transparent: true  }), //RIGHT
        ...
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/military/"+this.frontTex+".gif"), side: THREE.FrontSide, opacity: params.opacity,transparent: true  }), //FRONT
        new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("textures/military/"+this.frontTex+".gif"), side: THREE.FrontSide, opacity: params.opacity,transparent: true  }), //BACK
        ];
    ...
    constructor(frontTex,crow,ccol){
    super();
