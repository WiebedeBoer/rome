...
<div class="worldmap">
	...
	<g z-index="6"><text x="1800" y="120" font-size="120" fill="black" stroke="rgb(128,128,128)" stroke-width="2">Graves</text></g>
	@foreach($towns as $town)
			@if($town->gravecount >=1)
				<g z-index="2">
				<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (grave)</title>
