...
<div class="worldmap">
	...
	@foreach($towns as $town) 
		@if($town->scent =="incense caravan")
			...
			<circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(89,72,69)" stroke="rgb(92,0,0)" stroke-width="4" /></a>
			</g>
		@elseif($town->scent =="incense")
			<g z-index="2">
			<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (incense)</title>
			<circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(89,72,69)" stroke="rgb(192,0,0)" stroke-width="4" /></a>
			</g>
		@elseif($town->scent =="mastic")
			<g z-index="2">
			<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (mastic)</title>
			<circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(163,169,97)" stroke="black" stroke-width="4" /></a>
			</g>
		@elseif($town->scent =="storax")
			<g z-index="2">
			<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (storax)</title>
			<circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(135,139,124)" stroke="black" stroke-width="4" /></a>
			</g>
		@elseif($town->scent =="cedar")
			<g z-index="2">
			<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (cedar)</title>
			<circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(111,99,79)" stroke="yellow" stroke-width="4" /></a>
			</g>
		@else
			<g z-index="2">
