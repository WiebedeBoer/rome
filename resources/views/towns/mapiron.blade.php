...
<div class="worldmap">
	...
	<g z-index="6"><text x="1800" y="120" font-size="120" fill="black" stroke="rgb(128,128,128)" stroke-width="2">Iron</text></g>
	@foreach($towns as $town) 
		@if($town->iron =="iron")
		<g z-index="2">
			<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (iron)</title><circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(161,157,148)" stroke="black" stroke-width="4" /></a>
			</g>
		@else
		<g z-index="2">
