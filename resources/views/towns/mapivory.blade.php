...
@include('towns.mapmenu')
	...
	@foreach($towns as $town) 
		@if($town->sculpture =="ivory")
			<g z-index="2">
			<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (ivory)</title><circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(239,220,190)" stroke="black" stroke-width="4" /></a>
			</g>
		@else
		<g z-index="2">
