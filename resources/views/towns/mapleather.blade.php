...
<div class="worldmap">
	...
	@foreach($towns as $town)
			@if(($town->cattle =="cattle" || $town->wool =="goat" || $town->wool =="sheep" || $town->pig =="pig" || $town->game =="deer" || $town->pack =="donkey" || $town->pack =="oxen") && $town->paper =="parchment")
				<g z-index="2">
				<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (leatherworks and parchment)</title>
				<circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="14" fill="rgb(64,32,0)" stroke="rgb(224,0,224)" stroke-width="5" /></a></g>
			@elseif(($town->cattle =="cattle" || $town->wool =="goat" || $town->wool =="sheep" || $town->pig =="pig" || $town->game =="deer" || $town->pack =="donkey" || $town->pack =="oxen") && $town->paper !="parchment")
				<g z-index="2">
