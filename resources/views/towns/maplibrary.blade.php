...
<div class="worldmap">
	...
	@foreach($towns as $town) 
		@if($town->bibliotheca =="bibliotheca")
		<g z-index="2">
			<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (bibliotheca)</title><circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(255,255,0)" stroke="black" stroke-width="4" /></a>
			</g>
		@else
		<g z-index="2">
