...
@include('towns.mapmenu')
	...
	@foreach($towns as $town) 
		@if($town->pack =="horse")
		    <g z-index="2">
			<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (horse)</title><circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(106,91,77)" stroke="black" stroke-width="4" /></a>
			</g>
