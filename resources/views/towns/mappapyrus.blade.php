...
@include('towns.mapmenu')
	...
	@foreach($towns as $town) 
		@if($town->paper =="papyrus")
		    <g z-index="2">
			<a xlink:href="/towns/{{$town->town_id}}"><title>{{$town->town_name}} (papyrus)</title><circle cx="{{$town->xcoord}}" cy="{{$town->ycoord}}" r="12" fill="rgb(251,252,221)" stroke="black" stroke-width="4" /></a>
			</g>
